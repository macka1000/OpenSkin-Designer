...
namespace OpenSkinDesigner.Structures
{
    class sAttributeWidget : sAttribute
    {
        ...
        public String Text
        {
            get
            {
                if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") return pLabel.Text;
                else return "(none)";
            }
            set
            {
                if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext")
                {
                    pLabel.Text = value;
                }
            }
        ...
        public String PreviewText
        {
            get
            {
                if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") return pLabel.pPreviewText;
                else return "(none)";
            }
        }
        ...
        public String Font
        {
            get
            {
                if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") return pLabel.Font;
                else return "(none)";
            }
            set
            {
        ...
        public float FontSize
        {
            get
            {
                if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") return pLabel.FontSize;
                else return 0;
            }
            set
            {
        ...
        public String ForegroundColor
        {
            get
            {
                if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") return pLabel.ForegroundColor;
                else return "(none)";
            }
            set
            {
        ...
        public String BackgroundColor
        {
            get
            {
                if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") return pLabel.BackgroundColor;
                else return "(none)";
            }
            set
            {
        ...
        public String Valign
        {
            get
            {
                if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") return pLabel.Valign;
                else return "(none)";
            }
            set { if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") pLabel.Valign = value; }
        }
        ...
        public String Halign
        {
            get
            {
                if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") return pLabel.Halign;
                else return "(none)";
            }
            set { if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") pLabel.Halign = value; }
        }
        ...
        public bool noWrap
        {
            get
            {
                if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") return pLabel.pNoWrap;
                else return false;
            }
            set { if (pRender.ToLower() == "label" || pRender.ToLower() == "fixedlabel" || pRender.ToLower() == "vrunningtext") pLabel.noWrap = value; }
        }
